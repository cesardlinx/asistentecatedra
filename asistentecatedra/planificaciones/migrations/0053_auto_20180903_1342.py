...
def create_indicadores(apps, schema_editor):
    ...
    criterio1_1 = CriterioEvaluacion.objects.get(codigo="CE.CN.1.1.")
    criterio1_2 = CriterioEvaluacion.objects.get(codigo="CE.CN.1.2.")
    criterio1_3 = CriterioEvaluacion.objects.get(codigo="CE.CN.1.3.")
    criterio1_4 = CriterioEvaluacion.objects.get(codigo="CE.CN.1.4.")
    criterio1_5 = CriterioEvaluacion.objects.get(codigo="CE.CN.1.5.")
    ...
    Indicador.objects.bulk_create([
        ...
        Indicador(
            description=(
                "Identifica las características (crecer, reproducirse, "
                "responder a estímulos), necesidades (alimento, aire, agua), "
                "hábitat e importancia de los seres vivos (ser humano, "
                "animales domésticos y silvestres, plantas cultivadas y "
                "silvestres) de su entorno inmediato. (J.3., I.2., I.3.)"
            ),
            codigo="I.CN.1.1.1.",
        ...
        Indicador(
            description=(
                "Diferencia objetos inertes (rocas, agua, silla, etc.) de "
                "seres vivos (plantas, animales y ser humano) de su entorno, "
                "en función de las características, necesidades y hábitat. "
                "(J.3., I.2.)"
            ),
            codigo="I.CN.1.1.2.",
            criterio_evaluacion=criterio1_1
        ...
        Indicador(
            description=(
                "Discrimina, desde su propia experiencia, la importancia de "
                "las plantas y animales de su entorno. (J.3., I.2.)"
            ),
            codigo="I.CN.1.1.3.",
            criterio_evaluacion=criterio1_1
        ),
        Indicador(
            description=(
                "Reconoce a partir de la observación directa y/o "
                "representaciones gráficas, plantas cultivadas y silvestres "
                "y animales domésticos y silvestres. (J.3., I.2.)"
            ),
            codigo="I.CN.1.1.4.",
            criterio_evaluacion=criterio1_1
        ),
        Indicador(
            description=(
                "Expone comportamientos de respeto y cuidado hacia el "
                "hábitat y los seres vivos de su entorno. (J.3., I.2.,I.3.)"
            ),
            codigo="I.CN.1.1.5.",
            criterio_evaluacion=criterio1_1
        ),
        Indicador(
            description=(
                "Relaciona las partes principales de su cuerpo y los órganos "
                "de los sentidos con su función y percepciones del mundo que "
                "lo rodean. (J.3., I.2.)"
            ),
            codigo="I.CN.1.2.1.",
        ...
        Indicador(
            description=(
                "Promueve hábitos (higiene corporal, alimentación sana, "
                "juego y descanso) y medidas preventivas para una vida "
                "saludable. (J.3., I.2.)"
            ),
            codigo="I.CN.1.2.2.",
            criterio_evaluacion=criterio1_2
        ...
        Indicador(
            description=(
                "Comunica de forma oral la importancia de los órganos de los "
                "sentidos para obtener información sensorial (escuchar, "
                "hablar, sentir, ver, oler) de su vida diaria. (J.3.,I.2.)"
            ),
            codigo="I.CN.1.2.3.",
            criterio_evaluacion=criterio1_2
        ),
        Indicador(
            description=(
                "Distingue en objetos de uso cotidiano las propiedades "
                "físicas de la materia (forma, textura, color, tamaño, peso, "
                "flexibilidad, dureza, tendencia a flotar o hundirse, "
                "permeabilidad, transparencia, luminosidad y magnetismo). "
                "(J.3., I.2.)"
            ),
            codigo="I.CN.1.3.1.",
        ...
        Indicador(
            description=(
                "Clasifica objetos de uso cotidiano, en función del tipo de "
                "materiales naturales (algodón, madera, cuero, metal) y "
                "artificiales (plástico, vidrio, goma, hormigón). (J.3., "
                "I.2.)"
            ),
            codigo="I.CN.1.3.2.",
            criterio_evaluacion=criterio1_3
        ...
        Indicador(
            description=(
                "Relaciona el movimiento de objetos de su entorno inmediato "
                "con la fuerza ejercida (halar o empujar). (J.3., I.2.)"
            ),
            codigo="I.CN.1.3.3.",
            criterio_evaluacion=criterio1_3
        ),
        Indicador(
            description=(
                "Comunica, de forma oral, el procedimiento y los cambios que "
                "se producen en los materiales, al exponer objetos de uso "
                "cotidiano a agentes naturales ( calor, luz, agua y fuerza). "
                "(J.3., I.2., I.3.)"
            ),
            codigo="I.CN.1.3.4.",
            criterio_evaluacion=criterio1_3
        ...
        Indicador(
            description=(
                "Detecta, desde la observación de su entorno inmediato, "
                "diferentes fuentes de luz (natural y artificial). "
                "(J.3.,I.2.)"
            ),
            codigo="I.CN.1.4.1.",
        ...
        Indicador(
            description=(
                "Detecta desde la percepción del entorno inmediato fuentes "
                "de sonido, (débiles y fuertes) y los compara con el ruido. "
                "(J.3., I.2.)"
            ),
            codigo="I.CN.1.4.2.",
            criterio_evaluacion=criterio1_4
        ...
        Indicador(
            description=(
                "Explica las características de los elementos naturales "
                "(animales, platas, cuerpos de agua) construidos como parte "
        ...
        Indicador(
            description=(
                "Explica las características del tiempo atmosférico (lluvia, "
                "viento, nubes, variación de temperatura), sus cambios y "
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('planificaciones', '0052_auto_20180825_1443'),
    ]
