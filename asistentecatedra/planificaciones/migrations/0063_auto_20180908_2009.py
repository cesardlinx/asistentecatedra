...
def create_relationships(apps, schema_editor):
    ...
    # Destrezas
    destreza1_1_1 = Destreza.objects.get(codigo="CS.1.1.1.")
    destreza1_1_2 = Destreza.objects.get(codigo="CS.1.1.2.")
    destreza1_1_3 = Destreza.objects.get(codigo="CS.1.1.3.")
    destreza1_1_4 = Destreza.objects.get(codigo="CS.1.1.4.")
    destreza1_1_5 = Destreza.objects.get(codigo="CS.1.1.5.")
    destreza1_1_6 = Destreza.objects.get(codigo="CS.1.1.6.")
    destreza1_1_7 = Destreza.objects.get(codigo="CS.1.1.7.")
    destreza1_1_8 = Destreza.objects.get(codigo="CS.1.1.8.")
    destreza1_1_9 = Destreza.objects.get(codigo="CS.1.1.9.")
    destreza1_1_10 = Destreza.objects.get(codigo="CS.1.1.10.")
    destreza1_1_11 = Destreza.objects.get(codigo="CS.1.1.11.")
    destreza1_2_1 = Destreza.objects.get(codigo="CS.1.2.1.")
    destreza1_2_2 = Destreza.objects.get(codigo="CS.1.2.2.")
    destreza1_2_3 = Destreza.objects.get(codigo="CS.1.2.3.")
    destreza1_2_4 = Destreza.objects.get(codigo="CS.1.2.4.")
    destreza1_2_5 = Destreza.objects.get(codigo="CS.1.2.5.")
    destreza1_2_6 = Destreza.objects.get(codigo="CS.1.2.6.")
    destreza1_2_7 = Destreza.objects.get(codigo="CS.1.2.7.")
    destreza1_2_8 = Destreza.objects.get(codigo="CS.1.2.8.")
    destreza1_2_9 = Destreza.objects.get(codigo="CS.1.2.9.")
    destreza1_3_1 = Destreza.objects.get(codigo="CS.1.3.1.")
    destreza1_3_2 = Destreza.objects.get(codigo="CS.1.3.2.")
    destreza1_3_3 = Destreza.objects.get(codigo="CS.1.3.3.")
    destreza1_3_4 = Destreza.objects.get(codigo="CS.1.3.4.")
    destreza1_3_5 = Destreza.objects.get(codigo="CS.1.3.5.")
    destreza1_3_6 = Destreza.objects.get(codigo="CS.1.3.6.")
    destreza1_3_7 = Destreza.objects.get(codigo="CS.1.3.7.")
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('planificaciones', '0062_auto_20180908_2006'),
    ]
