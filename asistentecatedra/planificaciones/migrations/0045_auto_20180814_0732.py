...
def create_destrezas(apps, schema_editor):
    ...
    Destreza.objects.bulk_create([
        ...
        Destreza(
            description=(
                "Reconocer que es un ser que siente, piensa, opina y tiene "
        ...
        Destreza(
            description=(
                "Comunicar sus datos personales, para reconocer sus nombres "
                "y apellidos, edad, teléfono y el lugar donde vive."
            ),
            codigo="CS.1.1.2.",
            imprescindible=True,
            asignatura=estudios_sociales,
        ...
        Destreza(
            description=(
                "Reconocer su historia personal y familiar, desde su "
                "nacimiento."
            ),
            codigo="CS.1.1.3.",
            imprescindible=True,
        ...
        Destreza(
            description=(
                "Comprender su identidad como parte de un núcleo familiar y "
                "de una comunidad."
            ),
            codigo="CS.1.1.4.",
            asignatura=estudios_sociales,
        ...
        Destreza(
            description=(
                "Participar en actividades de recreación y celebración de su "
                "entorno familiar."
            ),
            codigo="CS.1.1.5.",
            asignatura=estudios_sociales,
        ...
        Destreza(
            description=(
                "Identificar el nombre de su país y las características "
                "comunes de los ecuatorianos y ecuatorianas."
            ),
            codigo="CS.1.1.6.",
            imprescindible=True,
            asignatura=estudios_sociales,
        ...
        Destreza(
            description=(
                "Practicar hábitos de alimentación, higiene y cuidado "
        ...
        Destreza(
            description=(
                "Participar con entusiasmo y autonomía en las actividades "
        ...
        Destreza(
            description=(
                "Demostrar responsabilidad en la realización de actividades "
                "y tareas cotidianas."
            ),
            codigo="CS.1.1.9.",
            asignatura=estudios_sociales,
        ...
        Destreza(
            description=(
                "Distinguir las situaciones de peligro de su entorno "
        ...
        Destreza(
            description=(
                "Practicar las normas de seguridad de su centro escolar "
                "desde la autorregulación para cuidarse a sí mismo."
            ),
            codigo="CS.1.1.11.",
            imprescindible=True,
            asignatura=estudios_sociales,
        ...
        Destreza(
            description=(
                "Dialogar, mostrando respeto por el criterio y las opiniones "
                "de los demás, en el medio en el que se desenvuelve."
            ),
            codigo="CS.1.2.1.",
            asignatura=estudios_sociales,
            subnivel=preparatoria,
        ...
        Destreza(
            description=(
                "Asumir compromisos y responsabilidades con su nuevo "
                "ambiente escolar."
            ),
            codigo="CS.1.2.2.",
            asignatura=estudios_sociales,
        ...
        Destreza(
            description=(
                "Aceptar, respetar y practicar los acuerdos establecidos por "
                "el grupo, con el fin de integrarse al mismo."
            ),
            codigo="CS.1.2.3.",
            asignatura=estudios_sociales,
            subnivel=preparatoria,
        ...
        Destreza(
            description=(
                ...
                "de su medio natural y social inmediato."
            ),
            codigo="CS.1.2.4.",
            imprescindible=True,
            asignatura=estudios_sociales,
        ...
        Destreza(
            description=(
                "Practicar normas de respeto consigo mismo y con los demás "
                "seres que lo rodean."
            ),
            codigo="CS.1.2.5.",
            imprescindible=True,
        ...
        Destreza(
            description=(
                "Reconocer las diferencias individuales que existen entre "
                "sus compañeros y personas que lo rodean, en función de "
                "respetarlas y valorarlas como diversidad."
            ),
            codigo="CS.1.2.6.",
            asignatura=estudios_sociales,
            subnivel=preparatoria,
        ...
        Destreza(
            description=(
                "Reconocer sus derechos y responsabilidades, mediante "
                "ejemplos reales."
            ),
            codigo="CS.1.2.7.",
            imprescindible=True,
        ...
        Destreza(
            description=(
                "Identificar la organización del establecimiento educativo, "
                "las personas que lo componen, las diferentes dependencias y "
                "su funcionamiento."
            ),
            codigo="CS.1.2.8.",
            imprescindible=True,
        ...
        Destreza(
            description=(
                "Reconocer la existencia de diferentes tipos de familias, "
                "destacando la importancia de valorarlas y respetarlas."
            ),
            codigo="CS.1.2.9.",
            asignatura=estudios_sociales,
            subnivel=preparatoria,
        ...
        Destreza(
            description=(
                "Identificar las dependencias de las viviendas, destacando "
        ...
        Destreza(
            description=(
                "Reconocer la utilidad de la tecnología en las actividades "
                "cotidianas."
            ),
            codigo="CS.1.3.2.",
            asignatura=estudios_sociales,
        ...
        Destreza(
            description=(
                "Identificar el uso de los medios de comunicación, incluidas "
                "las TIC, a partir del reconocimiento de su utilidad y "
                "beneficio."
            ),
            codigo="CS.1.3.3.",
            asignatura=estudios_sociales,
        ...
        Destreza(
            description=(
                "Identificar las principales ocupaciones y profesiones a "
                "partir del reconocimiento de su trabajo en beneficio de la "
                "comunidad."
            ),
            codigo="CS.1.3.4.",
            asignatura=estudios_sociales,
        ...
        Destreza(
            description=(
                "Reconocer los medios de transporte más comunes mediante "
                "imágenes que los relacionen con el medio en los que estos "
                "transitan."
            ),
            codigo="CS.1.3.5.",
            imprescindible=True,
        ...
        Destreza(
            description=(
                "Describir y apreciar lugares, tradiciones y costumbres "
                "importantes de su región y país, por medio de la "
                "observación de imágenes y la escucha de relatos que forman "
        ...
        Destreza(
            description=(
                "Identificar alguna de las manifestaciones culturales "
                "(música, comida, festividades y tradición oral) de la "
                "localidad."
            ),
            codigo="CS.1.3.7.",
            imprescindible=True,
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('planificaciones', '0044_auto_20180814_0700'),
    ]
