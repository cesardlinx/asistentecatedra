...
def create_objetivos(apps, schema_editor):
    ...
    Objetivo.objects.bulk_create([
        ...
        Objetivo(
            description=(
                "Reconocer la posición y atributos de colecciones de "
        ...
        Objetivo(
            description=(
                "Comprender la noción de cantidad, las relaciones de orden, "
                "y las nociones de adición y sustracción, con el uso de "
                "material concreto, para desarrollar su pensamiento y "
        ...
        Objetivo(
            description=(
                "Reconocer, comparar y describir las características de "
                "cuerpos y figuras geométricas de su entorno inmediato para "
        ...
        Objetivo(
            description=(
                "Explicar los procesos de medición, estimación y/o "
                "comparación de longitudes, capacidades y masas mediante el "
                "uso de unidades no convencionales en la resolución de "
                "problemas."
            ),
            codigo='O.M.1.4.',
            subnivel=preparatoria,
        ...
        Objetivo(
            description=(
                "Reconocer situaciones cotidianas del entorno en las que "
        ...
        Objetivo(
            description=(
                "Comunicar ideas sobre la interpretación del entorno "
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('planificaciones', '0023_auto_20180806_1746'),
    ]
