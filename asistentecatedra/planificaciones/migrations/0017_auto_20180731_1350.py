...
def create_objetivos(apps, schema_editor):
    ...
    Objetivo.objects.bulk_create([
        ...
        Objetivo(
            description=(
                "Reconocer que, además de la lengua oral, existe la lengua "
                "escrita para comunicarse, aprender y construir significados "
                "del mundo real y imaginario."
            ),
            codigo='O.LL.1.1.',
        ...
        Objetivo(
            description=(
                "Reconocer la existencia de variaciones del habla castellana "
                "como expresiones de la diversidad cultural del país."
            ),
            codigo='O.LL.1.2.',
            subnivel=preparatoria,
            asignatura=lengua_literatura
        ...
        Objetivo(
            description=(
                "Expresarse oralmente de manera espontánea y fluida, con "
                "claridad y entoncación, para interactuar con los demás en "
        ...
        Objetivo(
            description=(
                "Disfrutar de textos literarios y no literarios para "
                "explotar diversos temas y desarrollar ideas para la "
                "compransión del entorno."
            ),
            codigo='O.LL.1.4.',
            subnivel=preparatoria,
            asignatura=lengua_literatura
        ...
        Objetivo(
            description=(
                "Disfrutar de la biblioteca de aula y explorar las TIC como "
                "apoyo en las vivencias de animación a la lectura y "
                "escritura."
            ),
            codigo='O.LL.1.5.',
            subnivel=preparatoria,
        ...
        Objetivo(
            description=(
                "Experimentar la escritura como un medio de expresión "
                "personal y de comunicación, mediante el uso de sus propios "
                "códigos."
            ),
            codigo='O.LL.1.6.',
            subnivel=preparatoria,
        ...
        Objetivo(
            description=(
                "Disfrutar de textos literarios con el propósito de "
                "despertar la imaginación y la sensibilidad lúdica frente a "
                "las palabras."
            ),
            codigo='O.LL.1.7.',
            subnivel=preparatoria,
        ...
        Objetivo(
            description=(
                "Recrear textos literarios leídos o escuchados para expresar "
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('planificaciones', '0016_auto_20180731_0902'),
    ]
