...
def create_relationships(apps, schema_editor):
    ...
    # Destrezas
    destreza1_1_1 = Destreza.objects.get(codigo="CN.1.1.1.")
    destreza1_1_2 = Destreza.objects.get(codigo="CN.1.1.2.")
    destreza1_2_1 = Destreza.objects.get(codigo="CN.1.2.1.")
    destreza1_3_1 = Destreza.objects.get(codigo="CN.1.3.1.")
    destreza1_3_2 = Destreza.objects.get(codigo="CN.1.3.2.")
    destreza1_3_3 = Destreza.objects.get(codigo="CN.1.3.3.")
    destreza1_3_4 = Destreza.objects.get(codigo="CN.1.3.4.")
    destreza1_3_6 = Destreza.objects.get(codigo="CN.1.3.6.")
    destreza1_3_7 = Destreza.objects.get(codigo="CN.1.3.7.")
    destreza1_3_8 = Destreza.objects.get(codigo="CN.1.3.8.")
    destreza1_3_9 = Destreza.objects.get(codigo="CN.1.3.9.")
    destreza1_3_10 = Destreza.objects.get(codigo="CN.1.3.10.")
    destreza1_3_11 = Destreza.objects.get(codigo="CN.1.3.11.")
    destreza1_3_12 = Destreza.objects.get(codigo="CN.1.3.12.")
    destreza1_3_13 = Destreza.objects.get(codigo="CN.1.3.13.")
    destreza1_3_14 = Destreza.objects.get(codigo="CN.1.3.14.")
    destreza1_3_16 = Destreza.objects.get(codigo="CN.1.3.16.")
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('planificaciones', '0061_auto_20180908_2004'),
    ]
