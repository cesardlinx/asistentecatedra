...
def create_criterios(apps, schema_editor):
    ...
    CriterioEvaluacion.objects.bulk_create([
        ...
        CriterioEvaluacion(
            description=(
                "Reconoce que es un ser integral(sienta, piensa, opina) con "
                "características personales, que conforman su identidad y lo "
                "hacen parte de una comunidad y un núcleo familiar, con una "
                "estructura y dinámica, que lo identifican."
            ),
            codigo="CE.CS.1.1.",
        ...
        CriterioEvaluacion(
            description=(
                "Practica con autonomía sus responsabilidades personales "
                "(hábitos de higiene, alimentación, cuidado y seguridad "
                "personal) dentro de los espacios en los que comparte (casa "
                "y escuela)."
            ),
            codigo="CE.CS.1.2.",
            asignatura=estudios_sociales,
        ...
        CriterioEvaluacion(
            description=(
                "Reconoce y respeta las diferencias individuales que existen "
                "en su entorno social, valorando los aportes y cumpliendo "
                "con los acuerdos y responsabilidades de los espacios a los "
                "que pertenece."
            ),
            codigo="CE.CS.1.3.",
            asignatura=estudios_sociales,
        ...
        CriterioEvaluacion(
            description=(
                "Reconoce la organización y dependencias de la vivienda y "
                "escuela, identificando la utilidad de la tecnología en esos "
                "espacios."
            ),
            codigo="CE.CS.1.4.",
            asignatura=estudios_sociales,
        ...
        CriterioEvaluacion(
            description=(
                "Identifica alguna de las manifestaciones culturales(música, "
                "comida, festividades, tradición oral) de la localidad y "
                "describe los lugares, tradiciones y costumbres importantes "
                "de la región y país a la que pertenece."
            ),
            codigo="CE.CS.1.6.",
            asignatura=estudios_sociales,
            subnivel=preparatoria
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('planificaciones', '0030_auto_20180808_1840'),
    ]
