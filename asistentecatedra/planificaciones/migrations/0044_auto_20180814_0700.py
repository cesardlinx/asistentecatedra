...
def create_destrezas(apps, schema_editor):
    ...
    Destreza.objects.bulk_create([
        ...
        Destreza(
            description=(
                "Explorar y describir las partes principales de su cuerpo y "
                "su funcionamiento, en forma global y parcial, y "
                "diferenciarlas con respecto a aquellas de las personas que "
                "le rodean."
            ),
            codigo="CN.1.1.1.",
            imprescindible=True,
        ...
        Destreza(
            description=(
                "Ubicar en su cuerpo los órganos de los sentidos, describir "
                "sus funciones, y explorar las percepciones y sensaciones "
        ...
        Destreza(
            description=(
                "Explorar sus necesidades básicas y describir hábitos de "
                "vida saludable, proponer medidas preventivas y aplicarlas "
        ...
        Destreza(
            description=(
                "Observar y diferenciar entre los seres vivos y la materia "
        ...
        Destreza(
            description=(
                "Observar e identificar los animales domésticos y silvestres "
                "de la localidad, describir su utilidad y reconocer la "
        ...
        Destreza(
            description=(
                "Explorar y reconocer las plantas cultivadas y silvestres de "
                "la localidad, describir su utilidad e identificar las "
                "formas de cuidarlas."
            ),
            codigo="CN.1.3.4.",
            asignatura=ciencias_naturales,
        ...
        Destreza(
            description=(
                "Explorar, identificar y proteger el lugar donde viven las "
                "plantas y los animales y relacionar sus características "
                "externas con su hábitat."
            ),
            codigo="CN.1.3.5.",
            imprescindible=True,
            asignatura=ciencias_naturales,
        ...
        Destreza(
            description=(
                "Experimentar e identificar las propiedades físicas de los "
        ...
        Destreza(
            description=(
                "Explorar e identificar los materiales de los objetos, "
                "clasificarlos por su origen y describir su utilidad."
            ),
            codigo="CN.1.3.8.",
            imprescindible=True,
            asignatura=ciencias_naturales,
        ...
        Destreza(
            description=(
                "Explorar el movimiento de los objetos ante la acción de una "
                "fuerza y describir la causa del movimiento de los objetos."
            ),
            codigo="CN.1.3.9.",
            imprescindible=True,
            asignatura=ciencias_naturales,
        ...
        Destreza(
            description=(
                "Indagar, en forma guiada, las fuentes de luz; diferenciar "
                "la luz natural de la artificial."
            ),
            codigo="CN.1.3.10.",
            imprescindible=True,
            asignatura=ciencias_naturales,
        ...
        Destreza(
            description=(
                "Explorar y describir las fuentes de sonidos, clasificar "
                "estos en naturales o artificiales, fuertes o débiles, y "
        ...
        Destreza(
            description=(
                "Observar, describir y graficar las características de los "
        ...
        Destreza(
            description=(
                ...
                "y los cambios del tiempo atmosférico local, medir los "
                "cambios con instrumentos de fácil manejo, registrarlos con "
                "símbolos."
            ),
            codigo="CN.1.3.13.",
            imprescindible=True,
        ...
        Destreza(
            description=(
                "Identificar los efectos del cambio del tiempo atmosférico "
                "en animales, plantas e incluso en sí mismo."
            ),
            codigo="CN.1.3.14.",
            imprescindible=True,
            asignatura=ciencias_naturales,
        ...
        Destreza(
            description=(
                "Observar, en forma guiada, las funciones de los sentidos, "
                "hacer preguntas y dar respuestas sobre la importancia que "
                "tienen los sentidos para la obtención de información del "
                "entorno."
            ),
            codigo="CN.1.3.15.",
            imprescindible=True,
        ...
        Destreza(
            description=(
                "Explorar sobre las características de las plantas de un "
                "bosque o jardín y de un lago o acuario, relacionar las "
                "características de las plantas con el medio en el que viven "
                "y comunicarlo en forma gráfica."
            ),
            codigo="CN.1.3.16.",
            asignatura=ciencias_naturales,
            subnivel=preparatoria,
        ...
        Destreza(
            description=(
                "Experimentar y observar los cambios de los materiales de "
                "los objetos de uso cotidiano, a la acción del calor, la "
                "luz, el agua y la fuerza y comunicar los resultados de la "
                "experiencia."
            ),
            codigo="CN.1.3.17.",
            asignatura=ciencias_naturales,
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('planificaciones', '0043_auto_20180813_1621'),
    ]
