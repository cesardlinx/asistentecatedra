...
urlpatterns = [
     ...
     path('plan_anual/create/', views.plan_anual_create,
          name="plan_anual_create"),
     path('plan_anual/update/<int:pk>/<slug:slug>/', views.plan_anual_update,
     ...
     path('plan_unidad/create/', views.plan_unidad_create,
          name="plan_unidad_create"),
     path('plan_unidad/update/<int:pk>/<slug:slug>/', views.plan_unidad_update,
     ...
     path('plan_destrezas/create/', views.plan_destrezas_create,
          name="plan_destrezas_create"),
     path('plan_destrezas/update/<int:pk>/<slug:slug>/',
          views.plan_destrezas_update,
